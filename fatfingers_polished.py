...
class Trader:
    ...
    def volcanic_rock_voucher_fair_value(
        ...
        volatility_factor = min(std_diff * 2, 2.0)  # Scale thresholds with volatility

        zscore_threshold = {
            "VOLCANIC_ROCK_VOUCHER_9500": 1.3 * volatility_factor,
            "VOLCANIC_ROCK_VOUCHER_9750": 1.5 * volatility_factor,
            "VOLCANIC_ROCK_VOUCHER_10000": 0.9 * volatility_factor,  # More sensitive ATM
            "VOLCANIC_ROCK_VOUCHER_10250": 1.3 * volatility_factor,
            "VOLCANIC_ROCK_VOUCHER_10500": 1.4 * volatility_factor,
        }
